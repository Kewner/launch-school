...
// - Every object it creates gets its own copy of the methods, which is not
//   memory-efficient.
// - There's no way to trace by which function an object was created.
...
// Now we can build a factory function to create payments. The function can
...
// property is not present in the argument, it should return the sum of
// the phone and internet service charges; if the amount property is present,
