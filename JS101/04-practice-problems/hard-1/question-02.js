...
// The object is now { first: [1, 2] } because, since an array is an object,
// it's pass by reference. Thus, both numArray and the value of the
// 'first' key in the object point to the same array.
